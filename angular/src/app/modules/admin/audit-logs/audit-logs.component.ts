...
import { AuditLogsService } from '../../../service/api/audit-logs/audit-logs.service';
...
export class AuditLogsComponent extends PagedListingComponentBase<AuditlogsDto> implements OnInit {
