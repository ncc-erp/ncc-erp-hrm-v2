...
//////////////////
  ...
  public getPayslipPreviewToSendEmail(payslipId: number): Observable<ApiResponseDto<any>> {
  ...
  public changePayslipWithTokenForOnePayslip(payslipId: any, mezonToken: any, benefitId: any): Observable<any> {
