...
export class AccountServiceProxy {
  ...
  changeRolePermission(input: RolePermissionDto): Observable<any> {
    return this.http.post(
      this.baseUrl + '/api/services/app/Role/ChangeRolePermission',
      input
    );
  }
...
export class RoleServiceProxy {
  ...
  removeUserFromOutRole(id: number): Observable<any>{
    return this.http.delete<any>(this.baseUrl + '/api/services/app/Role/RemoveUserFromOutRole?Id='+id)
  }
...
export class RoleDtoPagedResultDto implements IRoleDtoPagedResultDto {
  ...
  init(data?: any) {
    if (data) {
      ...
      if (Array.isArray(data['items'])) {
        this.items = [] as any;
        for (let item of data['items']) this.items.push(RoleDto.fromJS(item));
      }
    }
  }
...
export class TenantDtoPagedResultDto implements ITenantDtoPagedResultDto {
  ...
  init(data?: any) {
    if (data) {
      ...
      if (Array.isArray(data['items'])) {
        this.items = [] as any;
        for (let item of data['items']) this.items.push(TenantDto.fromJS(item));
      }
    }
  }
...
export class UserDtoPagedResultDto implements IUserDtoPagedResultDto {
  ...
  init(data?: any) {
    if (data) {
      ...
      if (Array.isArray(data['items'])) {
        this.items = [] as any;
        for (let item of data['items']) this.items.push(UserDto.fromJS(item));
      }
    }
  }
