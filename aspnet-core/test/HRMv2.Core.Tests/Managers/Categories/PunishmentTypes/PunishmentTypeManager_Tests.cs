    ...
    public class PunishmentTypeManager_Tests : HRMv2CoreTestBase
    {
        ...
        public void GetAll_Test1()
        {
            ...
            WithUnitOfWork(() =>
            {
                ...
                result.ShouldContain(punishmentType => punishmentType.Api == "http://timesheetapi.nccsoft.vn/api/services/app/HRMv2/GetPunishtmentCheckin");
            });
        }
        ...
        public async Task Create_Test1()
        {
            ...
            var newPunishmentType = new PunishmentTypeDto
            {
                ...
                Name = "Checkout",
                IsActive = false,
                Api = "http://stg-api-timesheet.nccsoft.vn/api/services/app/HRMv2/GetPunishtmentCheckout"
            };
            var expectedId = 14;
