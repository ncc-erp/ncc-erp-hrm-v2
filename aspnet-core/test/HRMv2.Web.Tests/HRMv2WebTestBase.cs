...
{
    public abstract class HRMv2WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HRMv2WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HRMv2WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HRMv2DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HRMv2DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HRMv2DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HRMv2DbContext, Task<T>> func)
        {
            T result;
