...
using static HRMv2.Users.Dto.CreateUpdateUserInfoDto;

namespace HRMv2.Users
{
    [AbpAuthorize(PermissionNames.Admin_User)]
    public class UserAppService : AsyncCrudAppService<User, UserDto, long, PagedUserResultRequestDto, CreateUserDto, UserDto>, IUserAppService
    {
        ...
        [AbpAuthorize(PermissionNames.Admin_User_Create)]
        ...
        [HttpPut]
        [AbpAuthorize(PermissionNames.Admin_User_Edit)]
        ...
        [HttpPut]
        [AbpAuthorize(PermissionNames.Admin_User_EditUserRole)]
        ...
        [AbpAuthorize(PermissionNames.Admin_User_Delete)]
        ...
        [AbpAuthorize(PermissionNames.Admin_User_ResetPassword)]
