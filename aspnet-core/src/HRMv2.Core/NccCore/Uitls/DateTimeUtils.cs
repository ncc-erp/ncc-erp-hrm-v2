...
namespace NccCore.Uitls
{
    public class DateTimeUtils
    {
        ...
        public static string ToStringStandardDateTime(DateTime dateTime)
        {
        ...
        public static List<DateTime> GetListMonthsForCreate()
        {
            ...
            listDate.Add(now.AddMonths(-1));
            listDate.Add(now.AddMonths(-2));
            listDate.Add(now.AddMonths(-3));
            listDate.Add(now.AddMonths(-4));
            for (int m = 1; m <= 30; m++)
            {
